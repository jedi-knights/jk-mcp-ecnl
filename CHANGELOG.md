...
- **evals:** live-instance replay via MCP_EVAL_REMOTE_URL (P2) (#11) (9a4a01d)

## 0.5.0 (2026-06-28)

### Features

- **tools:** extended annotations — sensitivity, cost_class, rate_limit_class (P1) (3054d07)
...
- **ecnl:** MCP server for ECNL/ECRL schedules, standings, and RPI (eb2d69e)
...
[jedi-knights/go-semantic-release](https://github.com/jedi-knights/go-semantic-release).
